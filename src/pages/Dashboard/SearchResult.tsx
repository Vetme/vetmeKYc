  ...
  return (
    <DashboardLayout>
      <div className="">
        ...
        <div className="w-full relative my-3 h-[60px]">
          <div
            className="absolute w-full bg-white z-10 grid items-center p-3 text-[12px] text-[#453953] border border-[#453953] h-[54px] rounded-xl"
            style={{ gridTemplateColumns: "15% 20% 25% 20% 20%" }}
          >
