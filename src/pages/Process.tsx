                        ...
                        <div className="relative">
                          ...
                          >
                            ...
                            <p className="text-[0.8em] text-center capitalize">
                              Please upload a copy of your valid identification
                              in PNG, JPEG, or PDF format no longer than 3mb in
                              size
                            </p>
                            {/* </div> */}
                          </label>
          ...
          <TabPanel className="absolute">
            <div className="mb-16">
              ...
              <div className="">
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center lg:gap-6">
                  <TextInput
                    label="First Name"
                    inputCustomClassNames="w-[50%] lg:w-[70%] left-[21%] lg:left-[50%]"
                    shapeCustomClassNames="w-[48%] lg:w-11/12"
                    labelCustomClassNames="left-[29px] lg:left-[33px]"
                  />
                  <TextInput
                    label="Middle Name"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center lg:gap-6 ">
                  <TextInput label="Social Media" />
                  <TextInput label="Date Of Birth" />
                </div>
              </div>
              <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-6 mb-4 ml-[38px] w-[679px]">
                <div
                  className="bg-[#D9D9D94D] border border-[#453953] rounded-lg h-[52px] grid gap-4 items-center
              py-1 px-3 uppercase"
                  style={{ gridTemplateColumns: "10% 60% 10%" }}
            ...
            <div className="h-[600px]">
              ...
              <div className="relative left-6">
                <img src="shape8.png" alt="" />
                <img
                  src="id-card.png"
                  alt=""
                  className="absolute top-[12px] left-[31px]"
                />
            ...
            <div className="h-[350px] mt-16">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-6">
                <TextInput label="Country of Residence" />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-6">
                <TextInput label="Home Address 1" />
                <TextInput label="Office Address 1" />
              </div>
            </div>
          ...
          <TabPanel className="absolute">
            ...
            <div className="font-light leading-[30px] w-11/12 text-justify">
              ...
              <p className="mb-4">
                ...
                magna non ligula vestibulum eleifend. Nulla varius volutpat
