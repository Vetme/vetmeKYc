...
const Sidebar = () => {
  return (
    <div className="hidden lg:block  bg-[#EFF1EA] border border-[#453953] rounded-[10px] h-screen min-h-[500px] w-[322px]">
      <div className="relative flex flex-col h-[500px] justify-center items-start px-3 gap-5">
